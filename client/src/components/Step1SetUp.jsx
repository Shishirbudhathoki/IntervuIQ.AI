        ...
        <motion.div
            ...
            <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
                <motion.div
                    ...
                    className="relative bg-linear-to-br from green-50 to-green-100 p-8 flex flex-col justify-center" >
                ...
                >
                    ...
                    <div className="space-y-4">
                        ...
                        <div className='relative'>
                            <FaBriefcase className="absolute top-4 left-2 text-gray-400 " />
                            <input
                                type='text'
