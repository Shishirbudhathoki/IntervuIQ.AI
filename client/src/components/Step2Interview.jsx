...
function Step2Interview({ interviewData, onFinish }) {
    ...
    useEffect(() => {
        ...
        const runIntro = async () => {
            if (isIntroPhase) {
                await speakText(`Hello ${userName}, welcome to your interview. I hope you're feeling confident and ready.`);

                await speakText("I'll ask you a few questions. Just answer naturally, and try not to overthink. Let's get started!");
        ...
        <div className="min-h-screen bg-linear-to-br from-emerald-50 via-white to-teal-100 flex items-center justify-center p-4 sm:p-6">
            <div className="w-full max-w-230 min-h-[90vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col md:flex-row overflow-hidden">
                ...
                <div className="w-full md:w-[35%] bg-white flex flex-col items-center p-6 space-y-6 border-r border-gray-200">
                    ...
                    {/* subtitle pending */}
                    {subtitle && (
                        <div className="w-full max-w-md bg-gray-100 border-gray-200 p-4 rounded-xl shadow-sm">
                ...
                {/* Text Section */}
                <div className="flex-1 flex flex-col p-8 sm:p-7 md:p-6 relative">
                    <h2 className="text-xl sm:text-2xl font-bold text-emerald-600 mb-3 ">
                        AI Smart Interview
                    </h2>

                    {!isIntroPhase && <div className="relative mb-5 bg-gray-50 p-2 sm:p-2.5 rounded-2xl border border-gray-200 shadow-sm">
                    ...
                    {!feedback ? (<div className="flex items-center gap-4 mt-6">
                        <motion.button
                            onClick={toggleMic}
                            whileTap={{ scale: 0.9 }}
                            className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full bg-black text-white shadow-lg">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="flex-1 bg-linear-to-r from-emerald-600 to-teal-500 text-white py-2 rounded-2xl shadow-lg hover:opacity-90 transition font-semibold disabled:bg-gray-500">
                        ...
                        <motion.div
                            ...
                            className="mt-6 p-4 bg-emerald-50 border border-emerald-200 rounded-2xl shadow-sm"
                        >
                            <p className="text-emerald-700 font-medium mb-4">{feedback}</p>
                            <button
                                onClick={handleNext}
                                className="w-full bg-linear-to-r from-emerald-600 to-teal-500 text-white py-2 rounded-xl shadow-md hover:opacity-90 transition flex items-center justify-center gap-2">
